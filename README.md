...
Arquitectura: Separación de Responsabilidades (SoC) y Programación Asíncrona (async/await).
...
Protección Anti-Fuerza Bruta: Bloqueo automático de cuenta por 15 minutos tras el 5to intento fallido, con redirección a soporte técnico.

Activación de Cuenta: Flujo de validación con redirección automatizada al Login.
...
Extensión Asíncrona: Uso de Fetch API para refrescar la sesión sin recargar la página, optimizando la experiencia del usuario.
...
👤 Autor
Renato Meza - Ingeniería de Sistemas - UNMSM.
